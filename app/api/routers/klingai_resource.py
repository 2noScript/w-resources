...
from app.crawlers.generative.klingai.crawler import KlingaiCrawler
from config.settings import Settings
from app.api.models.APIBaseModel import RequestModel


crawler = KlingaiCrawler()
...
async def get_tags() -> Union[ResponseModel, ErrorResponseModel]:
    return ResponseModel(
        data=crawler.fetch_tags(), version=Settings.KlingaiSettings.version
    )
...
async def get_explore(
    ...
    try:
        ...
        return ResponseModel(
            ...
            data=data,
            metadata=metadata,
            version=Settings.KlingaiSettings.version,
        )
